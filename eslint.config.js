...
module.exports = tseslint.config(
  ...
  js.configs.recommended,
  {
    ...
    rules: {
      ...
      // understand type-only names (e.g. AxiosResponse, AxiosAdapter) and false-positives.
      'no-undef': 'off',
      // The generated client and its mocked-transport tests use `any` deliberately
      // (proxy stand-ins, window globals, axios adapter shims) — TypeScript still type-checks.
