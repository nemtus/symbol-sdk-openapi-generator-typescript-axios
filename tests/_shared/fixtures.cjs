...
//
// The typescript-axios client returns an AxiosResponse, so callers pass
// `response.data` (the DTO) — these helpers assert on that DTO directly, exactly
// like the typescript-fetch variant does on its parsed model.
